...
## [1.22.0](https://github.com/CCEW/career-ops/compare/career-ops-v1.21.0...career-ops-v1.22.0) (2026-07-17)


### Features

* add first-class OpenCode support alongside Claude Code ([#707](https://github.com/CCEW/career-ops/issues/707)) ([2710fbe](https://github.com/CCEW/career-ops/commit/2710fbe9b31cd0c6d1a8765cd5e04c255ede4ca3))
* add interview skill modes — plan, practice, debrief ([#956](https://github.com/CCEW/career-ops/issues/956)) ([e17a829](https://github.com/CCEW/career-ops/commit/e17a829b0a69262fcf3eacab01791aadf1e42154))
* add modes/_custom.md for user custom instructions ([#1198](https://github.com/CCEW/career-ops/issues/1198)) ([3cc8844](https://github.com/CCEW/career-ops/commit/3cc8844c51975e2bcd94cb9078bc734a75626c71))
* add opt-in plugin system (engine + supply-chain governance + registry) ([5ae518a](https://github.com/CCEW/career-ops/commit/5ae518a371a62a7dac190d98ffd1685880b782f4))
* add optional profile photo support for resume template ([#264](https://github.com/CCEW/career-ops/issues/264)) ([#1221](https://github.com/CCEW/career-ops/issues/1221)) ([ec18624](https://github.com/CCEW/career-ops/commit/ec18624ca6deb1defe205e8e3e7ea3c8107dabc6))
* add the opt-in experimental web UI surface (web/) — isolated versioning, CI and packaging ([432c3c5](https://github.com/CCEW/career-ops/commit/432c3c523a13bf0a5053b5d1f3c28c17ef1296eb))
* **add:** /career-ops add — fetch a project/paper/role into cv.md and article-digest.md ([#1476](https://github.com/CCEW/career-ops/issues/1476)) ([933c353](https://github.com/CCEW/career-ops/commit/933c3536959f29534769fcb92af37c3a60551475))
* **agent-inbox:** queue requests for the next session ([#1472](https://github.com/CCEW/career-ops/issues/1472)) ([182554d](https://github.com/CCEW/career-ops/commit/182554d1401f0be91b8474df9918dfaf5491c684))
* **apply:** ATS auto-fill for Greenhouse / Ashby / Lever — prepare, don't submit ([#1248](https://github.com/CCEW/career-ops/issues/1248)) ([215e6d1](https://github.com/CCEW/career-ops/commit/215e6d12f51e3f677c834ee81494320cf887a570))
* **apply:** ATS behavioural question matcher from story-bank.md ([#1228](https://github.com/CCEW/career-ops/issues/1228)) ([9d79931](https://github.com/CCEW/career-ops/commit/9d7993153ffa914f80c3f5198d2deec1f963e49f))
* **apply:** pre-scan forms for knock-out questions before drafting ([#1463](https://github.com/CCEW/career-ops/issues/1463)) ([05a85b8](https://github.com/CCEW/career-ops/commit/05a85b8bb1b32991a6bed16c19080e47f19a414b))
* **apply:** warn before reapplying to a repeat company ([#1921](https://github.com/CCEW/career-ops/issues/1921)) ([6cdca85](https://github.com/CCEW/career-ops/commit/6cdca856bfeb6017abbb826afeb0f7282d9dc6f9)), closes [#1920](https://github.com/CCEW/career-ops/issues/1920)
* **arbeitsagentur:** config-driven remoteMatch + server-side homeoffice filter ([#1189](https://github.com/CCEW/career-ops/issues/1189)) ([a463308](https://github.com/CCEW/career-ops/commit/a4633080f4444a06f4b01b875a79137b534115fc))
* **archive:** add archive-posting.mjs to save live job postings as PDF ([#697](https://github.com/CCEW/career-ops/issues/697)) ([571b114](https://github.com/CCEW/career-ops/commit/571b114bb56aedc5d32a4ecd9a5861854acd4ae0))
* **batch:** add --limit flag + budget guide ([0607ee5](https://github.com/CCEW/career-ops/commit/0607ee57e176c93422732ee1ad1530cd606f70b6))
* **batch:** add --skip-pdf flag to batch-runner.sh ([#1182](https://github.com/CCEW/career-ops/issues/1182)) ([256a289](https://github.com/CCEW/career-ops/commit/256a289de8bac8ed134a556b62c8ef2bffc3d713))
* **batch:** add --status and --watch progress monitoring to batch-runner.sh ([#922](https://github.com/CCEW/career-ops/issues/922)) ([#966](https://github.com/CCEW/career-ops/issues/966)) ([802552f](https://github.com/CCEW/career-ops/commit/802552ff72809d36f42c00ff4cd36affb0f6bf1f))
* **batch:** apply compensation reliability checks to batch workers ([#1588](https://github.com/CCEW/career-ops/issues/1588)) ([d6cbb2a](https://github.com/CCEW/career-ops/commit/d6cbb2a126ef3e9361cb8ff331413df7db8ebd58))
* **browser-extract:** configurable jd-mode text cap via --max-chars ([#1810](https://github.com/CCEW/career-ops/issues/1810)) ([7b13dc9](https://github.com/CCEW/career-ops/commit/7b13dc9fc0fa5aaf5e8086fa38fd72c629fde080))
* **calibration:** funnel-velocity.mjs — own funnel vs market benchmarks ([#1693](https://github.com/CCEW/career-ops/issues/1693), part 1) ([#1694](https://github.com/CCEW/career-ops/issues/1694)) ([ff6a022](https://github.com/CCEW/career-ops/commit/ff6a02258a25a8b7f6105a5c2104f9baf6acdf70))
* classify application replies and generate review digest ([#1620](https://github.com/CCEW/career-ops/issues/1620)) ([f33f9e7](https://github.com/CCEW/career-ops/commit/f33f9e74a5bffcefe7c1433730f1275f3d71060e)), closes [#1585](https://github.com/CCEW/career-ops/issues/1585)
* **cli:** add Antigravity CLI compatibility ([61de18d](https://github.com/CCEW/career-ops/commit/61de18db165cf864c11afd7d4e3224bc7fe6596b))
* **cli:** add first-class Codex support ([#1269](https://github.com/CCEW/career-ops/issues/1269)) ([43a7d0e](https://github.com/CCEW/career-ops/commit/43a7d0eb6d7c24232f47a482c7ea0178b00c824d))
* **cli:** add Grok Build CLI support ([0a89381](https://github.com/CCEW/career-ops/commit/0a8938186ed8a4787a84b2e5bc1680a55aac59ca))
* **cli:** register Kimi as a supported CLI host ([#1193](https://github.com/CCEW/career-ops/issues/1193)) ([d3d34f3](https://github.com/CCEW/career-ops/commit/d3d34f38ecabd2fbbe4b387c53504577a6255b6f))
* **contacto:** short-greeting variant for chat-style outreach ([#1477](https://github.com/CCEW/career-ops/issues/1477)) ([8cf19a7](https://github.com/CCEW/career-ops/commit/8cf19a76ad381eeebfb7d35abd9d282006c24214))
* **cover-letter:** support --format and --report CLI arguments ([#1830](https://github.com/CCEW/career-ops/issues/1830)) ([88c75cf](https://github.com/CCEW/career-ops/commit/88c75cf47a35ea9c41ed803d89f1d288989f2699)), closes [#1828](https://github.com/CCEW/career-ops/issues/1828)
* **cover:** add optional salutation/greeting to cover letters ([#1010](https://github.com/CCEW/career-ops/issues/1010)) ([99346c1](https://github.com/CCEW/career-ops/commit/99346c148fbd19e4040be457f860b27fe678e8d7))
* **cover:** load _profile.md so personalization governs the letter ([#1012](https://github.com/CCEW/career-ops/issues/1012)) ([dff56d3](https://github.com/CCEW/career-ops/commit/dff56d3903c85251e6fdd008feb02ba464a5d0dc))
* **cv:** add opt-in profile photo for DACH/European CVs ([fcccd58](https://github.com/CCEW/career-ops/commit/fcccd58abf4be7b2d620576ffe754861cab933d4))
* **cv:** fact validator — block invented metrics in generated CVs ([#682](https://github.com/CCEW/career-ops/issues/682)) ([b9decee](https://github.com/CCEW/career-ops/commit/b9decee90eb00140b89912681deb34d7ecf48f94))
* **dashboard:** add cover letter hotkey to report viewer ([#994](https://github.com/CCEW/career-ops/issues/994)) ([8a5cc51](https://github.com/CCEW/career-ops/commit/8a5cc51d57bad926e97a4a4011ddd945ffbbfa51))
* **dashboard:** add in-viewer status picker overlay ([#1195](https://github.com/CCEW/career-ops/issues/1195)) ([cc53485](https://github.com/CCEW/career-ops/commit/cc534858f5a52bfe0af50c1188c2665488b20c94))
* **dashboard:** add Spanish (es) locale to the i18n catalog ([#1783](https://github.com/CCEW/career-ops/issues/1783)) ([2ddb9ce](https://github.com/CCEW/career-ops/commit/2ddb9ce548667a0a8adb68e2bdac098d3b3310ff)), closes [#1764](https://github.com/CCEW/career-ops/issues/1764)
* **dashboard:** customizable columns with column picker ([#979](https://github.com/CCEW/career-ops/issues/979)) ([9d1404f](https://github.com/CCEW/career-ops/commit/9d1404f32022b552e2dea1d773e0a10a22e2c004))
* **dashboard:** discard reason picker with learning loop ([#1465](https://github.com/CCEW/career-ops/issues/1465)) ([7845b11](https://github.com/CCEW/career-ops/commit/7845b11efc8d3dc58f1978096e6d4cd7c1cbc650)), closes [#1380](https://github.com/CCEW/career-ops/issues/1380)
* **dashboard:** Hired canonical status + job-landed celebration flow ([58736bc](https://github.com/CCEW/career-ops/commit/58736bc9b2a643f25f72758bc10c4d7ca45be651))
* **dashboard:** hotkeys to view (d) and regenerate (D) the CV PDF ([#797](https://github.com/CCEW/career-ops/issues/797)) ([07e4014](https://github.com/CCEW/career-ops/commit/07e4014b39006dce52d750d23110c3dcc18c717b))
* **dashboard:** i18n extraction for the Go TUI (split from [#1666](https://github.com/CCEW/career-ops/issues/1666)) ([#1672](https://github.com/CCEW/career-ops/issues/1672)) ([3b5ef4f](https://github.com/CCEW/career-ops/commit/3b5ef4f1052ae2029a2b3f0a024a57809ac36189))
* **dashboard:** manifesto shortcut, help entry and footer link ([64e81de](https://github.com/CCEW/career-ops/commit/64e81dee1ee0be48475d32248b26d928089f5d50))
* **dashboard:** recognize EUR/GBP/CHF pay and international cities in pipeline derive ([#1157](https://github.com/CCEW/career-ops/issues/1157)) ([a1c7ce2](https://github.com/CCEW/career-ops/commit/a1c7ce296afc0ab2657caefb63323ef544bf745b))
* **discovery:** seed company universe from VC portfolios (YC / a16z)… ([#1375](https://github.com/CCEW/career-ops/issues/1375)) ([9a816f5](https://github.com/CCEW/career-ops/commit/9a816f5488e9bfbee616b51f7121441ed2be07c3))
* **email:** add confirmed-time no-show follow-up variant ([#1860](https://github.com/CCEW/career-ops/issues/1860)) ([c77d138](https://github.com/CCEW/career-ops/commit/c77d138faf84e22422d8cb80195d8b4f524eff23)), closes [#1859](https://github.com/CCEW/career-ops/issues/1859)
* **email:** ATS-broken fallback scenario — recover a stuck application ([#1741](https://github.com/CCEW/career-ops/issues/1741)) ([#1745](https://github.com/CCEW/career-ops/issues/1745)) ([4caabf0](https://github.com/CCEW/career-ops/commit/4caabf04cf68036039b2112177ca95a4e06aa6f9))
* **email:** formal application email drafts — draft-only, never sends ([#1515](https://github.com/CCEW/career-ops/issues/1515)) ([f7dfb88](https://github.com/CCEW/career-ops/commit/f7dfb88f4d18a598db3d1d327648194d98807ef9))
* **eval:** add openai-eval.mjs for any OpenAI-compatible endpoint ([#1278](https://github.com/CCEW/career-ops/issues/1278)) ([5838391](https://github.com/CCEW/career-ops/commit/58383910c365e81f41deed34f6340636674d73f8))
...
* **find:** resolve a company/role/number query to its full pipeline identity ([#1439](https://github.com/CCEW/career-ops/issues/1439)) ([3fd0a06](https://github.com/CCEW/career-ops/commit/3fd0a06c14481633d28db5a47f9c9317205e9a7d))
* **followup:** seed a pinned first follow-up when a row turns Applied ([#1468](https://github.com/CCEW/career-ops/issues/1468)) ([ea6f608](https://github.com/CCEW/career-ops/commit/ea6f6086696c68d5437cf6c5007c4a90b161b011))
* **i18n:** add Chinese language modes for China-market job seekers ([#934](https://github.com/CCEW/career-ops/issues/934)) ([#965](https://github.com/CCEW/career-ops/issues/965)) ([207f960](https://github.com/CCEW/career-ops/commit/207f9600e4cf15718ae44d064c9e9ec7cc7a77b3))
* **i18n:** add German translations of interview modes ([#1610](https://github.com/CCEW/career-ops/issues/1610)) ([a6b6180](https://github.com/CCEW/career-ops/commit/a6b618012045fc543e3ced0db10bb1ad37cd75f9))
* **i18n:** add Hindi language support with dedicated modes and documentation ([7463d75](https://github.com/CCEW/career-ops/commit/7463d75013149c745f204c21c7823ded4e3f416a))
* **i18n:** add Indonesian (id) modes ([#1474](https://github.com/CCEW/career-ops/issues/1474)) ([6262d53](https://github.com/CCEW/career-ops/commit/6262d532494e01964c99a30c8ea1347bcd9de730))
* **i18n:** add Korean career-ops modes ([#1457](https://github.com/CCEW/career-ops/issues/1457)) ([ced5f74](https://github.com/CCEW/career-ops/commit/ced5f74b0eadde187e7de76e70f9ab1ce7918d64))
* **i18n:** add Traditional Chinese (zh-TW) modes ([#1371](https://github.com/CCEW/career-ops/issues/1371)) ([#1760](https://github.com/CCEW/career-ops/issues/1760)) ([d9c338d](https://github.com/CCEW/career-ops/commit/d9c338db88b868bb63549f2c998ae2dbb5d71ad7))
* **i18n:** Chinese salary reliability checks — zh mirror of the compensation tiers ([#1589](https://github.com/CCEW/career-ops/issues/1589)) ([5771478](https://github.com/CCEW/career-ops/commit/5771478c808435fff1ec0666bc0245dc7213d162))
* **i18n:** translate interview modes to French ([#1526](https://github.com/CCEW/career-ops/issues/1526)) ([53f77a0](https://github.com/CCEW/career-ops/commit/53f77a09000c3437285a77d3ad86e5e1c619a596)), closes [#1489](https://github.com/CCEW/career-ops/issues/1489)
* **i18n:** translate interview modes to Spanish ([#1523](https://github.com/CCEW/career-ops/issues/1523)) ([3657bf0](https://github.com/CCEW/career-ops/commit/3657bf0e8eb0cb2dc922ad43a94c7365c54250dc)), closes [#1490](https://github.com/CCEW/career-ops/issues/1490)
* **img-to-pdf:** convert a screenshot into a PDF for ATS uploads ([#1730](https://github.com/CCEW/career-ops/issues/1730)) ([#1731](https://github.com/CCEW/career-ops/issues/1731)) ([6b3b4e8](https://github.com/CCEW/career-ops/commit/6b3b4e824c480e8d1e3204c4a5a34c75d114e9f0))
* **interview-prep:** cross-reference coffee chat notes against interview intel ([#1941](https://github.com/CCEW/career-ops/issues/1941)) ([2692051](https://github.com/CCEW/career-ops/commit/269205162c4af846ca216b611b32d71ff920e012)), closes [#1940](https://github.com/CCEW/career-ops/issues/1940)
* **interview-prep:** structured Panel Intel table ([#1502](https://github.com/CCEW/career-ops/issues/1502)) ([72b1d5e](https://github.com/CCEW/career-ops/commit/72b1d5e8c442288b59c6455ce2eb25b99b283b4d))
* **interview-prep:** URL entry path for a role that was never evaluated ([#1817](https://github.com/CCEW/career-ops/issues/1817)) ([b9b54b8](https://github.com/CCEW/career-ops/commit/b9b54b8205515e66a41dc3461381dc895f4d9b2f)), closes [#1816](https://github.com/CCEW/career-ops/issues/1816)
* **interview-redflag:** flag scope/compensation mismatch as a separate fifth dimension ([#1943](https://github.com/CCEW/career-ops/issues/1943)) ([ea57b82](https://github.com/CCEW/career-ops/commit/ea57b82652cd7b261935f80001c80b3984843e0f)), closes [#1942](https://github.com/CCEW/career-ops/issues/1942)
* **interview-redflag:** suggest a ready-to-copy blacklist row at Reconsider level ([#1856](https://github.com/CCEW/career-ops/issues/1856)) ([b645e69](https://github.com/CCEW/career-ops/commit/b645e69ab96af5fe5483938da390108bfd816070)), closes [#1854](https://github.com/CCEW/career-ops/issues/1854)
* **interview/plan:** wire the existing Panel Intel table into multi-panelist rounds ([#1858](https://github.com/CCEW/career-ops/issues/1858)) ([a8ceed2](https://github.com/CCEW/career-ops/commit/a8ceed2b79c102cc33c0309f7201b385ec8ab091)), closes [#1857](https://github.com/CCEW/career-ops/issues/1857)
* **interview:** company red-flag detector from transcript signal ([0f4f16f](https://github.com/CCEW/career-ops/commit/0f4f16fafc941c0ed326a1344fb915eb649d83ed))
* **invite-match:** fuzzy-match interview-invite emails to tracker entries ([#1495](https://github.com/CCEW/career-ops/issues/1495)) ([10de9d4](https://github.com/CCEW/career-ops/commit/10de9d4ab48130d7c794028f00604ae8b9f56223))
* language.output preference — output language decoupled from market modes ([#1035](https://github.com/CCEW/career-ops/issues/1035)) ([4f512fb](https://github.com/CCEW/career-ops/commit/4f512fbdfa67057d7c06a37437a67f6f55428d45))
* **latex:** opt-in latex-tex in-place tailoring of user-owned .tex CVs ([#695](https://github.com/CCEW/career-ops/issues/695)) ([d7128ad](https://github.com/CCEW/career-ops/commit/d7128adfc877c39a82bc0f8edef83b4a5bc0bc0c))
* **ledger:** immutable n: ordinal per signature + first-contribution question for new signers ([8ec80b5](https://github.com/CCEW/career-ops/commit/8ec80b50d87c0ed3f145a74d62ce7f6771d929d1))
* **liveness:** add Workday to the zero-token ATS liveness API rung ([#1928](https://github.com/CCEW/career-ops/issues/1928)) ([f6afdf9](https://github.com/CCEW/career-ops/commit/f6afdf97c745de3fe9b6bdc3bb3198a6f412f3b0))
* **liveness:** zero-token ATS API check before Playwright (closes [#574](https://github.com/CCEW/career-ops/issues/574)) ([#1181](https://github.com/CCEW/career-ops/issues/1181)) ([44f9e64](https://github.com/CCEW/career-ops/commit/44f9e6438f8eeaa4dd9f7c36844354256c94f6ae))
* make CLAUDE.md a thin @AGENTS.md wrapper — single canonical agent spec ([#272](https://github.com/CCEW/career-ops/issues/272)) ([09528a3](https://github.com/CCEW/career-ops/commit/09528a34c46a9914a255489729bdc79b0940ae9b))
* match employer reply candidates to application tracker ([#1607](https://github.com/CCEW/career-ops/issues/1607)) ([30df267](https://github.com/CCEW/career-ops/commit/30df267615c205ee5e2506af15288009808a9205)), closes [#1584](https://github.com/CCEW/career-ops/issues/1584)
* **modes:** add Danish (da) locale ([5407811](https://github.com/CCEW/career-ops/commit/54078118a70fa6b42123a68450bb584206af8ac4))
* **modes:** add EU SWE application calibration mode ([f024317](https://github.com/CCEW/career-ops/commit/f02431721ad1cbb7e49882b23ebb4dec00eaafff))
* **modes:** add Polish (pl) locale modes ([#1129](https://github.com/CCEW/career-ops/issues/1129)) ([51711b3](https://github.com/CCEW/career-ops/commit/51711b34ad6764283308245f21023f6337926c12))
* **modes:** add recruiter-side application heuristics ([2ea0814](https://github.com/CCEW/career-ops/commit/2ea0814b8436aeae76200a70d2df6be795e498e0))
* **modes:** optional voice-dna.md writing guardrail ([#998](https://github.com/CCEW/career-ops/issues/998)) ([018eb0f](https://github.com/CCEW/career-ops/commit/018eb0f692b801104959739151a4303cf5d2717e))
* **modes:** wire the opt-in CLI extractor into the oferta + auto-pipeline JD paths ([#1804](https://github.com/CCEW/career-ops/issues/1804)) ([3cb7c5b](https://github.com/CCEW/career-ops/commit/3cb7c5bdac2ada5ead4edb5bdadd1c2d769ac3f4))
* **oferta:** Block G signal 7 — AI-buzzword vs infrastructure mismatch ([#1683](https://github.com/CCEW/career-ops/issues/1683)) ([#1685](https://github.com/CCEW/career-ops/issues/1685)) ([7dda430](https://github.com/CCEW/career-ops/commit/7dda4302bbadd376444734bed36925072d0c3b97))
* **oferta:** Block G signal for benefits terminology country mismatch ([#1936](https://github.com/CCEW/career-ops/issues/1936)) ([3f0985d](https://github.com/CCEW/career-ops/commit/3f0985d3eaea97d6c3d6bc1468e092bcb0bc4ec3)), closes [#1935](https://github.com/CCEW/career-ops/issues/1935)
* **oferta:** company-type + compensation-reliability tiers in evaluations ([#1587](https://github.com/CCEW/career-ops/issues/1587)) ([160093c](https://github.com/CCEW/career-ops/commit/160093cbcc4b44cc22af34160a17422bd58a88b5))
* **oferta:** employment classification risk signal in Block G ([#1631](https://github.com/CCEW/career-ops/issues/1631)) ([1d084a2](https://github.com/CCEW/career-ops/commit/1d084a2d6c813e7e51e7a9c8c0d5dfe21ef2d820)), closes [#1630](https://github.com/CCEW/career-ops/issues/1630)
* **oferta:** flag 'remote' location contradicted by JD-body signals ([#1459](https://github.com/CCEW/career-ops/issues/1459)) ([74b8fcb](https://github.com/CCEW/career-ops/commit/74b8fcb1d0bdf0ae6b8563ff805a7b814919b9c1))
* offer-prep mode — contract reading companion at Offer stage ([#1634](https://github.com/CCEW/career-ops/issues/1634)) ([4490c4b](https://github.com/CCEW/career-ops/commit/4490c4b0dda09638592a51c522fb7a6f1e3c9f22)), closes [#1608](https://github.com/CCEW/career-ops/issues/1608)
* **offer-prep:** negotiation reply-draft step — draft-only email from Items to raise ([0e79229](https://github.com/CCEW/career-ops/commit/0e79229772a7a2bebf38f04179d4702642fa885f))
* **ollama:** add local interactive Ollama evaluator ([#681](https://github.com/CCEW/career-ops/issues/681)) ([1b44790](https://github.com/CCEW/career-ops/commit/1b447901198fa4defba79062acc3ce1e219373f5))
* **onboarding:** route to the manifesto from the README and the first successful scan ([e3a82e0](https://github.com/CCEW/career-ops/commit/e3a82e07dff4955d23dd97ea61aeccfc10810a9c))
* **onboarding:** surface the CareerOps Manifesto after updates and setup ([84f2e53](https://github.com/CCEW/career-ops/commit/84f2e534dfba7ac3831f0fda670bc6c3eaced788))
* OpenRouter runner — free models, auto-blacklist, no Claude CLI required ([#53](https://github.com/CCEW/career-ops/issues/53)) ([bf380c7](https://github.com/CCEW/career-ops/commit/bf380c77c6fe74849482978c62b75db355c9b5f1))
* **openrouter:** prompt-cache the static system prefix via cache_control ([#1766](https://github.com/CCEW/career-ops/issues/1766)) ([4dacfc8](https://github.com/CCEW/career-ops/commit/4dacfc8b172653ecd99ea2223489cdf0c09df192))
* **patterns:** ATS channel yield analysis — algorithmic-monoculture aware ([#1405](https://github.com/CCEW/career-ops/issues/1405)) ([c3b5d9a](https://github.com/CCEW/career-ops/commit/c3b5d9a815fdd5831d77c07a0c5767f4ae123a0c))
...
* **patterns:** recruiting-process friction signal at company level ([#1467](https://github.com/CCEW/career-ops/issues/1467)) ([dde05bc](https://github.com/CCEW/career-ops/commit/dde05bc9427e0752723be0c07ae3621aa46ed67d))
* **patterns:** transcript-driven targeting correction (Step 1b) — closes [#960](https://github.com/CCEW/career-ops/issues/960) ([#961](https://github.com/CCEW/career-ops/issues/961)) ([ed497fb](https://github.com/CCEW/career-ops/commit/ed497fb71d67bc1ad03c57d466e1463e205a4fc7))
* **pdf:** add role name to the tailored PDF filename for multi-role tracking ([#1890](https://github.com/CCEW/career-ops/issues/1890)) ([e878096](https://github.com/CCEW/career-ops/commit/e8780965d93f4d699d79b8d86d8e0c1f68f66437))
* **pdf:** allow intentional CV section reordering via --allow-reorder ([1a615d9](https://github.com/CCEW/career-ops/commit/1a615d9ced3a5ea23afe17ddef031d85861f8b3b))
* **pdf:** deterministic HTML CV renderer to cut PDF-step token burn ([#557](https://github.com/CCEW/career-ops/issues/557)) ([#1681](https://github.com/CCEW/career-ops/issues/1681)) ([1e08297](https://github.com/CCEW/career-ops/commit/1e082972be2368d61937a05c681f7f0737b91eb9))
* **pdf:** JD skill-gap checker before CV generation, zero-LLM ([#1559](https://github.com/CCEW/career-ops/issues/1559)) ([8afdf0b](https://github.com/CCEW/career-ops/commit/8afdf0be0e3d8fa3e0fb351750a34fb08fcf3e39)), closes [#1558](https://github.com/CCEW/career-ops/issues/1558)
* **pdf:** render Japanese CVs with a lang="ja" CJK font fallback ([#1053](https://github.com/CCEW/career-ops/issues/1053)) ([d0d57d1](https://github.com/CCEW/career-ops/commit/d0d57d184649615b638812156a24c87ceafab8a2))
* **pipeline:** openai-tailor.mjs — headless CV tailoring for the no-agent path ([#1669](https://github.com/CCEW/career-ops/issues/1669)) ([#1671](https://github.com/CCEW/career-ops/issues/1671)) ([4abce71](https://github.com/CCEW/career-ops/commit/4abce712a3809aebabd30750d288c758dfad9d2b))
...
* **plugins:** seed/successor model — community plugins can supersede a bundled reference ([fa61b0c](https://github.com/CCEW/career-ops/commit/fa61b0cfcb84b16c01c07ea3ade0b03a0bae5061))
* **portals:** add verify-portals.mjs ATS slug validator ([#1016](https://github.com/CCEW/career-ops/issues/1016)) ([7aeb016](https://github.com/CCEW/career-ops/commit/7aeb01652d1b6c00ce31f561aa40b61c631515d0))
* **portals:** probe non-ATS boards through the provider layer ([#1529](https://github.com/CCEW/career-ops/issues/1529)) ([ba83606](https://github.com/CCEW/career-ops/commit/ba836064cea7a99873fc383b254c32a59d07f4dc))
* **profile:** candidate contact-channel preference for outreach CTAs ([#1557](https://github.com/CCEW/career-ops/issues/1557)) ([03a17b5](https://github.com/CCEW/career-ops/commit/03a17b5874578aab54e2ef9d36702e9c73ba6cf7)), closes [#1556](https://github.com/CCEW/career-ops/issues/1556)
* **providers:** 4dayweek auto-detect with spoof-safe host matching ([#1657](https://github.com/CCEW/career-ops/issues/1657) follow-up) ([333d620](https://github.com/CCEW/career-ops/commit/333d6203f770efcd52c5a7cf05ce5d5cb0811337))
* **providers:** add 4 Day Week provider (public zero-auth API) ([#1318](https://github.com/CCEW/career-ops/issues/1318)) ([575da5f](https://github.com/CCEW/career-ops/commit/575da5f2e99cf8ffd0ed74df229274a42679dd29))
* **providers:** add Arbeitnow provider ([#1301](https://github.com/CCEW/career-ops/issues/1301)) ([c018bfa](https://github.com/CCEW/career-ops/commit/c018bfac4810103ce4c59f07a7b4c0f98e21380a))
* **providers:** add BambooHR provider ([#1141](https://github.com/CCEW/career-ops/issues/1141)) ([39bb6b2](https://github.com/CCEW/career-ops/commit/39bb6b26151e9d1fae8dd6f55aa0deecd467d055))
* **providers:** add Breezy HR scanner provider ([#1185](https://github.com/CCEW/career-ops/issues/1185)) ([6249bcb](https://github.com/CCEW/career-ops/commit/6249bcb41be7ce0d05209d237e967cc910e46302))
* **providers:** add Comeet ATS provider ([#1222](https://github.com/CCEW/career-ops/issues/1222)) ([f5af817](https://github.com/CCEW/career-ops/commit/f5af81760436b38901ba4f1c090c1f077b90941e))
* **providers:** add Get on Board (getonbrd) zero-auth provider ([#1442](https://github.com/CCEW/career-ops/issues/1442)) ([c53a61c](https://github.com/CCEW/career-ops/commit/c53a61c7998f7cdfbf59500deb27493ad3d4ce18))
* **providers:** add Hacker News "Who is hiring?" provider (Algolia API) ([#1309](https://github.com/CCEW/career-ops/issues/1309)) ([011aeb4](https://github.com/CCEW/career-ops/commit/011aeb47b2089af91f23f02a7806018cdc3508fb))
* **providers:** add HigherEdJobs RSS provider ([#1350](https://github.com/CCEW/career-ops/issues/1350)) ([d280a7d](https://github.com/CCEW/career-ops/commit/d280a7dee24e9225c03f30cd0f47b78c56a14e76))
* **providers:** add Himalayas provider ([#1249](https://github.com/CCEW/career-ops/issues/1249)) ([1a6f13a](https://github.com/CCEW/career-ops/commit/1a6f13a25db340ff5d29c516efb078cbe10ffac4))
* **providers:** add JibeApply provider ([#1400](https://github.com/CCEW/career-ops/issues/1400)) ([311ed4a](https://github.com/CCEW/career-ops/commit/311ed4a0319d8ad4e8437c5c906d4d97255317f1))
* **providers:** add Jobicy provider ([#1260](https://github.com/CCEW/career-ops/issues/1260)) ([5a5782e](https://github.com/CCEW/career-ops/commit/5a5782ee68f77b9f5a41de79ff7de9acdf20bd65))
* **providers:** add Jobspresso provider ([#1320](https://github.com/CCEW/career-ops/issues/1320)) ([dd06e76](https://github.com/CCEW/career-ops/commit/dd06e76ffb37ca7d4bffa7ef2217b69bebff4781))
* **providers:** add Jobstreet and Glints providers for the Indonesian market ([728d547](https://github.com/CCEW/career-ops/commit/728d54777dd546fef37373b400aa13cfee38f374)), closes [#1085](https://github.com/CCEW/career-ops/issues/1085)
* **providers:** add Landing.jobs provider ([#1307](https://github.com/CCEW/career-ops/issues/1307)) ([c60c1eb](https://github.com/CCEW/career-ops/commit/c60c1eb824130d27c1fc82ce15b1435491dd480a))
* **providers:** add LaraJobs zero-auth RSS provider ([0f046b5](https://github.com/CCEW/career-ops/commit/0f046b5bd7f24a7ec13ba4a027183ca765d869ca))
* **providers:** add Lever EU instance (jobs.eu.lever.co) ([#1571](https://github.com/CCEW/career-ops/issues/1571)) ([bd81e37](https://github.com/CCEW/career-ops/commit/bd81e37181c0dab0a9d4c7e4c09a3e74997a7515))
* **providers:** add Meituan careers provider ([#1818](https://github.com/CCEW/career-ops/issues/1818)) ([0f6b096](https://github.com/CCEW/career-ops/commit/0f6b0966ab0f3fef22209513d1af3c949abdd787))
* **providers:** add NoDesk provider ([#1330](https://github.com/CCEW/career-ops/issues/1330)) ([7fca4dd](https://github.com/CCEW/career-ops/commit/7fca4dd264d6ddbc58978cb079c25d63119bf744))
* **providers:** add Oracle Recruiting Cloud zero-auth provider ([#1929](https://github.com/CCEW/career-ops/issues/1929)) ([52db048](https://github.com/CCEW/career-ops/commit/52db0484b7a506173b055bf23edcba4593233bb9))
* **providers:** add Personio ATS provider ([#1223](https://github.com/CCEW/career-ops/issues/1223)) ([f25570b](https://github.com/CCEW/career-ops/commit/f25570b3a5ecbaa18adf6ef6579e167ed3b68294))
* **providers:** add Pinpoint ATS provider ([#1287](https://github.com/CCEW/career-ops/issues/1287)) ([38271b2](https://github.com/CCEW/career-ops/commit/38271b2bc538c419c7b76ac120c8d291da57db5f))
* **providers:** add RemoteOK, Remotive, Working Nomads, IBM board providers ([349bacc](https://github.com/CCEW/career-ops/commit/349bacc9d9ad377d6d85ae35fe87625c1b3a6114)), closes [#1075](https://github.com/CCEW/career-ops/issues/1075)
* **providers:** add Rippling ATS provider ([#1303](https://github.com/CCEW/career-ops/issues/1303)) ([922ec5f](https://github.com/CCEW/career-ops/commit/922ec5fdd1fafcc59e91195723734a9c11ed272a))
* **providers:** add Teamtailor zero-auth RSS provider ([#1376](https://github.com/CCEW/career-ops/issues/1376)) ([eea80e9](https://github.com/CCEW/career-ops/commit/eea80e960a845645e7b68a5057227d26ff834713))
* **providers:** add Tencent careers zero-auth provider ([#230](https://github.com/CCEW/career-ops/issues/230)) ([95ba35c](https://github.com/CCEW/career-ops/commit/95ba35cfe3f7b6163959d21a493ba156bf524536))
* **providers:** add The Hub provider ([#1305](https://github.com/CCEW/career-ops/issues/1305)) ([19f221f](https://github.com/CCEW/career-ops/commit/19f221f60c7db881ba62fcd91127302b2844e9c7))
* **providers:** add The Muse provider ([#1283](https://github.com/CCEW/career-ops/issues/1283)) ([e0db3d7](https://github.com/CCEW/career-ops/commit/e0db3d74a98ab3d3a31123c6681329f8f72138c9))
* **providers:** add WeWorkRemotely RSS provider ([#1243](https://github.com/CCEW/career-ops/issues/1243)) ([39ea2d4](https://github.com/CCEW/career-ops/commit/39ea2d4324b1279737f7640e9d0b447a2608e159)), closes [#1241](https://github.com/CCEW/career-ops/issues/1241)
* **providers:** Amazon (amazon.jobs) and Avature zero-token providers ([#1480](https://github.com/CCEW/career-ops/issues/1480)) ([494e947](https://github.com/CCEW/career-ops/commit/494e9476cf215e336c255ac5a06fab231a2b256a))
* **providers:** avature self-heals jobOffset→offset pagination ([#1547](https://github.com/CCEW/career-ops/issues/1547)) ([7f1a171](https://github.com/CCEW/career-ops/commit/7f1a171c23c8f57096223fdf8220e274f2f5c1bc))
* **providers:** beesite (milch & zucker) + softgarden providers ([#1551](https://github.com/CCEW/career-ops/issues/1551)) ([220288e](https://github.com/CCEW/career-ops/commit/220288e93753933ceafe12f7bcb71ae6788bdeb0))
* **providers:** Cornerstone OnDemand (csod) + Rheinmetall ([#1549](https://github.com/CCEW/career-ops/issues/1549)) ([ffbbf41](https://github.com/CCEW/career-ops/commit/ffbbf41fb35df1a7b97cdcffecc3438d5e64ec86))
* **providers:** Dassault Systèmes zero-token provider (Exalead XML) ([#1498](https://github.com/CCEW/career-ops/issues/1498)) ([46c0e89](https://github.com/CCEW/career-ops/commit/46c0e894daf93d3ac1c683f98fb3bd27e8b1da24))
* **providers:** EchoJobs zero-auth JSON aggregator provider ([#1655](https://github.com/CCEW/career-ops/issues/1655)) ([9509882](https://github.com/CCEW/career-ops/commit/95098823e1150af51e9811c796f5a43d8ad8f5a7))
* **providers:** honour api: on workday and smartrecruiters ([#1496](https://github.com/CCEW/career-ops/issues/1496)) ([f77f846](https://github.com/CCEW/career-ops/commit/f77f8465a5dc79faed00c6e9510eea3fba76a4ca))
* **providers:** Phenom People (phenom) + Radancy TalentBrew (radancy) ([#1554](https://github.com/CCEW/career-ops/issues/1554)) ([e638fed](https://github.com/CCEW/career-ops/commit/e638fed2c00ceef9475e79922ac85fed1302a0b7))
* **providers:** port Arbeitsagentur to an in-process provider ([#1095](https://github.com/CCEW/career-ops/issues/1095)) ([504a2f0](https://github.com/CCEW/career-ops/commit/504a2f054625c16f777693a56c789599c0bacdfa))
* **providers:** SAP SuccessFactors (RMK) zero-token provider ([#1475](https://github.com/CCEW/career-ops/issues/1475)) ([67253c4](https://github.com/CCEW/career-ops/commit/67253c49638ef565a32a4aa9f98ef2c895adee5b))
* **providers:** SuccessFactors CSB strategy + bounded health-probe budget ([#1548](https://github.com/CCEW/career-ops/issues/1548)) ([81ab0ed](https://github.com/CCEW/career-ops/commit/81ab0ede1ac8592ced56b7904627f588092f837e))
* **providers:** TKMS, Heckler & Koch, and Deutsche Bahn providers ([#1555](https://github.com/CCEW/career-ops/issues/1555)) ([1422846](https://github.com/CCEW/career-ops/commit/14228466983f11a19bef1d311e92dbd365b4f221))
* **registry:** add career-ops-plugin-markdown v0.1.0 ([708fa8b](https://github.com/CCEW/career-ops/commit/708fa8b34069d30c74a7dc73b0e58cd4c9339eb7))
* **registry:** add career-ops-plugin-obsidian v0.1.0 ([#1399](https://github.com/CCEW/career-ops/issues/1399)) ([1b26648](https://github.com/CCEW/career-ops/commit/1b26648b148fd4efc345ad098c5f46d261e81d83))
* **registry:** add career-ops-plugin-tavily v0.1.0 ([#1348](https://github.com/CCEW/career-ops/issues/1348)) ([b5aa464](https://github.com/CCEW/career-ops/commit/b5aa464857ee141b03f376eb70c8614b2a24ca98))
* **registry:** add google-calendar plugin v0.1.0 ([#1347](https://github.com/CCEW/career-ops/issues/1347)) ([1ebc81f](https://github.com/CCEW/career-ops/commit/1ebc81fe17087efd4d318345b7b90d627e0b3c27))
* **registry:** add startup boards plugin ([#1413](https://github.com/CCEW/career-ops/issues/1413)) ([f2e1d08](https://github.com/CCEW/career-ops/commit/f2e1d080ca9eaa8022a53cc91eef313071892aa7))
* **registry:** register serper and theirstack provider plugins ([#1645](https://github.com/CCEW/career-ops/issues/1645), [#1697](https://github.com/CCEW/career-ops/issues/1697)) ([2958a2c](https://github.com/CCEW/career-ops/commit/2958a2c4b8d3c851758728b6e17e5b739d077c09))
* **registry:** split plugins-registry.json into per-plugin files ([#1401](https://github.com/CCEW/career-ops/issues/1401)) ([6d08316](https://github.com/CCEW/career-ops/commit/6d08316722f96af88f74959992d8bbab8c1d4228))
* **reply-watch:** paste-reply.mjs manual input path for users without Gmail ([#1803](https://github.com/CCEW/career-ops/issues/1803)) ([4f9e924](https://github.com/CCEW/career-ops/commit/4f9e9244ef556286993d9ef6bc8c49cd59f98275)), closes [#1802](https://github.com/CCEW/career-ops/issues/1802)
* **reports:** unified Risk Summary block joining the five company-risk signals ([#1738](https://github.com/CCEW/career-ops/issues/1738)) ([f0c742a](https://github.com/CCEW/career-ops/commit/f0c742a835dd03411b193d28540a3dd300cb2dc0)), closes [#1737](https://github.com/CCEW/career-ops/issues/1737)
* **reserve-report-num:** --count N contiguous range reservation ([#1454](https://github.com/CCEW/career-ops/issues/1454)) ([a70dd61](https://github.com/CCEW/career-ops/commit/a70dd61391d6ee4c7706b9d001dcd833b84547a9))
* **salary-gap:** track compensation figures stated per interview round ([#1853](https://github.com/CCEW/career-ops/issues/1853)) ([8308cd1](https://github.com/CCEW/career-ops/commit/8308cd1bbdf2231c743085062e049f0c751c1727)), closes [#1852](https://github.com/CCEW/career-ops/issues/1852)
* **salary:** mode wiring — advertised_comp + observation appends ([f0414ec](https://github.com/CCEW/career-ops/commit/f0414ec0f0e0ae2b86fa6a6e4bba602a721d1749))
* **salary:** salary-gap.mjs — append-only compensation observation analyzer ([8c6dcdd](https://github.com/CCEW/career-ops/commit/8c6dcddaaa14f61308b21b04004d2523f7514357))
* **scan:** add --json output, --include-undated, and --shuffle to scan-ats-full ([#1199](https://github.com/CCEW/career-ops/issues/1199)) ([12206f7](https://github.com/CCEW/career-ops/commit/12206f7e7b1bd9bafe0c8258b4951cab667e9f2e))
* **scan:** add content/description filter for providers ([#974](https://github.com/CCEW/career-ops/issues/974)) ([21d6c86](https://github.com/CCEW/career-ops/commit/21d6c86f12071217aefbcbca397ebb957f361f92))
* **scan:** add detect-reposts.mjs repost detection from scan-history.tsv ([#1212](https://github.com/CCEW/career-ops/issues/1212)) ([112f632](https://github.com/CCEW/career-ops/commit/112f6327cb08ce8461a5367be53a876968583df6))
* **scan:** add early trust validation and job trust metadata ([#985](https://github.com/CCEW/career-ops/issues/985)) ([ef07461](https://github.com/CCEW/career-ops/commit/ef07461a8d3c4b29418e39a450c0fae4450257f7))
* **scan:** add JustJoin and NoFluffJobs providers ([#989](https://github.com/CCEW/career-ops/issues/989)) ([7d1ca07](https://github.com/CCEW/career-ops/commit/7d1ca0750aabd8918a21bd4feebccec1e0389ee2))
* **scan:** add seniority-tier classifier with optional skip_tiers fi… ([#1361](https://github.com/CCEW/career-ops/issues/1361)) ([db6cbce](https://github.com/CCEW/career-ops/commit/db6cbce03e9290549488a801544ad4a74746c7b5))
* **scan:** data/blacklist.md — user-owned do-not-apply list ([#1742](https://github.com/CCEW/career-ops/issues/1742)) ([#1748](https://github.com/CCEW/career-ops/issues/1748)) ([9867d0e](https://github.com/CCEW/career-ops/commit/9867d0e7fa33fce009511acebe526755e326c244))
* **scan:** JD-content fingerprinting — flag agency+direct cross-listings ([#1601](https://github.com/CCEW/career-ops/issues/1601)) ([52154fd](https://github.com/CCEW/career-ops/commit/52154fd8544fcf949be7c430daa8def5c9319471)), closes [#1597](https://github.com/CCEW/career-ops/issues/1597)
* **scan:** opt-in CLI page extractor (browser-extract.mjs) ([557a97d](https://github.com/CCEW/career-ops/commit/557a97d44d7b6574fab8c5b61f448caba8bc08e2))
* **scan:** opt-in max_posting_age_days freshness gate ([#1578](https://github.com/CCEW/career-ops/issues/1578)) ([8b60a8c](https://github.com/CCEW/career-ops/commit/8b60a8cfbe487ce0254432695bab1c2989041df9))
* **scan:** persist and surface the scanner trust signal to pipeline and history ([#1765](https://github.com/CCEW/career-ops/issues/1765)) ([16c8497](https://github.com/CCEW/career-ops/commit/16c84976b1d39187edd22f6610c48049d00c79d6)), closes [#1743](https://github.com/CCEW/career-ops/issues/1743)
* **scan:** persist compensation to pipeline.md ([#1017](https://github.com/CCEW/career-ops/issues/1017)) ([8a4567d](https://github.com/CCEW/career-ops/commit/8a4567d39d8d93c9854d4be24086d50b36a49de1))
* **scan:** persist per-run scan counters to data/scan-runs.tsv ([#1606](https://github.com/CCEW/career-ops/issues/1606)) ([d0d9bd0](https://github.com/CCEW/career-ops/commit/d0d9bd05d75e87d2ab21a6ca440cc4ddd92c919b))
* **scan:** persist provider postedAt to pipeline and scan-history ([#1578](https://github.com/CCEW/career-ops/issues/1578)) ([300b6cb](https://github.com/CCEW/career-ops/commit/300b6cb613aff388eea632960c3d15110ee9411b))
* **scan:** preserve job location in pipeline.md ([#1015](https://github.com/CCEW/career-ops/issues/1015)) ([7671517](https://github.com/CCEW/career-ops/commit/76715172f3abc23c62af963977306f3ec721408e))
* **scan:** report unreachable boards with error classification + doctor sweep ([#1455](https://github.com/CCEW/career-ops/issues/1455)) ([fd3635f](https://github.com/CCEW/career-ops/commit/fd3635f67fc4a83be922306c7d18fb6fb74a296e))
* **scan:** scope content_filter per title-category via by_title_keyword ([9c5791b](https://github.com/CCEW/career-ops/commit/9c5791bf934d8e909944f6b8e232fc8326954774))
* **scan:** suppress duplicate roles via company aliases ([#1750](https://github.com/CCEW/career-ops/issues/1750)) ([b203ea4](https://github.com/CCEW/career-ops/commit/b203ea4183d78b22ca57045a9f9f94d716ef6036))
* **scan:** track portal health over time and surface coverage decay ([#1768](https://github.com/CCEW/career-ops/issues/1768)) ([9bc82e2](https://github.com/CCEW/career-ops/commit/9bc82e28620d1db6702b075f651a4ff991208bed)), closes [#1744](https://github.com/CCEW/career-ops/issues/1744)
* **scoring:** culture-screen dimension with structural capping ([dc2a8d8](https://github.com/CCEW/career-ops/commit/dc2a8d86464bdc719c709f6e0ab5554d83993074))
* **scripts:** add build:dashboard and serve:dashboard npm scripts ([#796](https://github.com/CCEW/career-ops/issues/796)) ([51f6ee4](https://github.com/CCEW/career-ops/commit/51f6ee4fe8e7af146c361ff831549f67d9de5f46))
* spend_tier config for model-agnostic model routing + batch pre-screen gate ([#1007](https://github.com/CCEW/career-ops/issues/1007)) ([4dec7eb](https://github.com/CCEW/career-ops/commit/4dec7eb2da549ad4712111eaece4719390efbe94))
* **stats:** lifetime pipeline stats aggregator ([#1605](https://github.com/CCEW/career-ops/issues/1605)) ([1b23baa](https://github.com/CCEW/career-ops/commit/1b23baa1159c01884a6dab54136031a1b5945097))
* **templates:** config-selectable CV and cover-letter templates ([#1690](https://github.com/CCEW/career-ops/issues/1690)) ([#1691](https://github.com/CCEW/career-ops/issues/1691)) ([7576cfd](https://github.com/CCEW/career-ops/commit/7576cfd8deb28eb0b7dd1a7c96cae8f44a91091d))
* titles mode — suggest adjacent job titles from the CV ([#1637](https://github.com/CCEW/career-ops/issues/1637)) ([2d7bb04](https://github.com/CCEW/career-ops/commit/2d7bb04247950ec4fbcf1f956895334b04daf349)), closes [#1632](https://github.com/CCEW/career-ops/issues/1632)
* **tracker:** add `delete --num N` to remove an application row safely ([#1200](https://github.com/CCEW/career-ops/issues/1200)) ([a644392](https://github.com/CCEW/career-ops/commit/a64439297e820f7de52d533eaa66b38ed5d08701))
* **tracker:** assessment-log.mjs — skills-assessment events with staleness signal ([#1684](https://github.com/CCEW/career-ops/issues/1684)) ([#1687](https://github.com/CCEW/career-ops/issues/1687)) ([d1be88b](https://github.com/CCEW/career-ops/commit/d1be88bb7b15839a4ee89841ee6ae582df7eb0ee))
* **tracker:** map tracker columns by header name ([#954](https://github.com/CCEW/career-ops/issues/954)) ([57b34c0](https://github.com/CCEW/career-ops/commit/57b34c07e01cd106528936398507e1b4552ca295))
* **tracker:** recognize "—"/"-" as valid score-cell N/A sentinels ([#1800](https://github.com/CCEW/career-ops/issues/1800)) ([7280df2](https://github.com/CCEW/career-ops/commit/7280df2b84e734a2080552d77d9d1afefe8b67cb)), closes [#1799](https://github.com/CCEW/career-ops/issues/1799)
* **tracker:** set-status.mjs — canonical CLI for tracker status updates ([#1460](https://github.com/CCEW/career-ops/issues/1460)) ([1750e4c](https://github.com/CCEW/career-ops/commit/1750e4c2f26b92b4b7bfd9013c03198361a93b1e)), closes [#1428](https://github.com/CCEW/career-ops/issues/1428)
* **tracker:** SQLite derived index over applications.md — phase 1 ([#919](https://github.com/CCEW/career-ops/issues/919)) ([5465f16](https://github.com/CCEW/career-ops/commit/5465f162bb71dec8a25391265bdd498db2d6b512))
...
* **updater:** structural SYSTEM_PATHS coverage check ([#1190](https://github.com/CCEW/career-ops/issues/1190)) ([cc44f78](https://github.com/CCEW/career-ops/commit/cc44f781270685ab2dcb5b6ba17d88b645412f97))
* **upskill:** aggregate skill-gap analysis from tracked reports ([#1520](https://github.com/CCEW/career-ops/issues/1520), phase 1) ([fd1f3c9](https://github.com/CCEW/career-ops/commit/fd1f3c957b4ab138850c0ceccef7c4d3a9720093))
* **upskill:** targeted &lt;URL&gt; single-posting mode with SSRF-guarded fetch ([#1796](https://github.com/CCEW/career-ops/issues/1796)) ([72e5983](https://github.com/CCEW/career-ops/commit/72e59839f8cce573f41031f41499ed63104b1d57)), closes [#1739](https://github.com/CCEW/career-ops/issues/1739)
* **verify:** detect duplicate and orphan reports ([#1425](https://github.com/CCEW/career-ops/issues/1425)) ([#1441](https://github.com/CCEW/career-ops/issues/1441)) ([5c42df3](https://github.com/CCEW/career-ops/commit/5c42df3613c4839055a769f81be595677a973c74))
...
* **analyzer:** resolve report paths relative to the tracker file ([#1679](https://github.com/CCEW/career-ops/issues/1679)) ([568025c](https://github.com/CCEW/career-ops/commit/568025c4677772b0882afbce3609c30ac1a3f7e8))
* **ashby:** include secondaryLocations so EU-eligible roles surface ([a84d3f5](https://github.com/CCEW/career-ops/commit/a84d3f51e436e8b36305c38d2ed5dd8438aa5f90)), closes [#1073](https://github.com/CCEW/career-ops/issues/1073)
* auto-create data/pipeline.md and harden Playwright doctor check ([#1059](https://github.com/CCEW/career-ops/issues/1059)) ([188cf76](https://github.com/CCEW/career-ops/commit/188cf7601aa5d776b10a0c33c035e4d0f6199dfe))
* **batch:** harden status score handling ([#1133](https://github.com/CCEW/career-ops/issues/1133)) ([fbce3f2](https://github.com/CCEW/career-ops/commit/fbce3f28db22a07750082514e4fbf456b379bf5a))
* **batch:** reconcile pipeline.md inbox after batch runs ([#712](https://github.com/CCEW/career-ops/issues/712)) ([34c3d0e](https://github.com/CCEW/career-ops/commit/34c3d0ea60e1dcfda4985112ef4577bbb8b1faf3))
* **batch:** single-worker lock fallback + exit-127 shim-swap retry ([#910](https://github.com/CCEW/career-ops/issues/910)) ([9a6e2ce](https://github.com/CCEW/career-ops/commit/9a6e2ce5eaaa841b6ffdeaa04af034e2ee063a0a))
* **batch:** use awk instead of bc for score math ([#735](https://github.com/CCEW/career-ops/issues/735)) ([afa74c2](https://github.com/CCEW/career-ops/commit/afa74c2b8755b2e0f33d164c92e0beccf528dc88))
* **contract:** expand interview-prep/* coverage in DATA_CONTRACT ([#1060](https://github.com/CCEW/career-ops/issues/1060)) ([d19db79](https://github.com/CCEW/career-ops/commit/d19db79554362cdd26736fef10bdaa9afaba4624))
...
* **cover:** resolve the cover-letter template through the shared resolver ([#1777](https://github.com/CCEW/career-ops/issues/1777)) ([7e1775c](https://github.com/CCEW/career-ops/commit/7e1775c483c70da7dc4e63cd9e78cbb286d7c8cf))
* **cv-template:** keep role header with its bullets when a location line is present ([#1903](https://github.com/CCEW/career-ops/issues/1903)) ([66b1024](https://github.com/CCEW/career-ops/commit/66b102490943d93ed3afd384b6fbc1e47c5d7d48))
* **cv-template:** keep role titles from orphaning at page breaks ([#1366](https://github.com/CCEW/career-ops/issues/1366)) ([cbde5c4](https://github.com/CCEW/career-ops/commit/cbde5c4d5c5e6a0c420ad550bfadcdaf78a1e6ca))
* **dashboard:** archetype regex matches English and Spanish reports ([#977](https://github.com/CCEW/career-ops/issues/977)) ([d619d3b](https://github.com/CCEW/career-ops/commit/d619d3b5ca24fda2ab94cf90111f2b42b2f2691a))
* **dashboard:** duplicate tracker headers resolve last-occurrence to match JS reader ([#1602](https://github.com/CCEW/career-ops/issues/1602)) ([edbfd8d](https://github.com/CCEW/career-ops/commit/edbfd8d4e4a395ced64fef13fea6d72c010dab08))
* **dashboard:** map tracker columns by header name ([#1327](https://github.com/CCEW/career-ops/issues/1327)) ([#1328](https://github.com/CCEW/career-ops/issues/1328)) ([8257f69](https://github.com/CCEW/career-ops/commit/8257f697ef0c0d5b9e0804344cb0275c80075059))
* **dashboard:** open Windows targets without shell ([#987](https://github.com/CCEW/career-ops/issues/987)) ([6dc36fb](https://github.com/CCEW/career-ops/commit/6dc36fb0792d1157ec96bfb5c3ac4f10cf303305))
* **dashboard:** report last-contact in calendar days, not hours-since-midnight ([#1057](https://github.com/CCEW/career-ops/issues/1057)) ([4e05cfd](https://github.com/CCEW/career-ops/commit/4e05cfda98b5dccfd2c664c12335ee20812b451b))
* **dashboard:** rewrite only the Status cell on status update ([#1186](https://github.com/CCEW/career-ops/issues/1186)) ([b1cba0f](https://github.com/CCEW/career-ops/commit/b1cba0feb1e6a8aa1bec2fdb143f3f53ff01fd11))
* **dedup:** require exact company+role match so distinct same-company roles survive ([#1458](https://github.com/CCEW/career-ops/issues/1458)) ([4f387f0](https://github.com/CCEW/career-ops/commit/4f387f04e44253c43462c5083e298cfb09a3c844))
* **deps:** update dependency playwright to v1.61.1 ([#1296](https://github.com/CCEW/career-ops/issues/1296)) ([88ebcf9](https://github.com/CCEW/career-ops/commit/88ebcf99d891c1592da12ee8335a9a78148fbac3))
...
* **deps:** update npm dependencies to v1.61.0 ([#1023](https://github.com/CCEW/career-ops/issues/1023)) ([5407247](https://github.com/CCEW/career-ops/commit/54072470ab440b1b358a18ab6de9672cc4cb5649))
* **doctor:** warn when Node is below 22.5 instead of passing silently ([#1831](https://github.com/CCEW/career-ops/issues/1831)) ([30e470d](https://github.com/CCEW/career-ops/commit/30e470dea58f06e077d920c0cf1f70f24f74bbbc)), closes [#1829](https://github.com/CCEW/career-ops/issues/1829)
* **envrc:** only load the Nix flake when Nix is installed ([#1863](https://github.com/CCEW/career-ops/issues/1863)) ([ca23af6](https://github.com/CCEW/career-ops/commit/ca23af67b40d83bac3f705467f1fb322a7cefe54))
* **eval:** bound research budget to a single-pass query cap ([#1262](https://github.com/CCEW/career-ops/issues/1262)) ([771577c](https://github.com/CCEW/career-ops/commit/771577cf47ec89b8162da6d6f2ef8f17d2628b42))
* **followup-cadence:** schedule first responded follow-up with responded_initial ([#1352](https://github.com/CCEW/career-ops/issues/1352)) ([e30dd0b](https://github.com/CCEW/career-ops/commit/e30dd0b3ec3a360dfa3d68f81f845c0269a8cf9a))
* **followup:** resolve report path relative to tracker directory ([752f3b9](https://github.com/CCEW/career-ops/commit/752f3b9d598686e56227d8c48063213fdd302a85)), closes [#1070](https://github.com/CCEW/career-ops/issues/1070)
* **followup:** use the real application date from notes, not the eval date ([#1096](https://github.com/CCEW/career-ops/issues/1096)) ([#1097](https://github.com/CCEW/career-ops/issues/1097)) ([53785c8](https://github.com/CCEW/career-ops/commit/53785c895750b5c69876ed5b1d6d05fb86c022be))
* **gemini:** validate evaluation report shape ([#819](https://github.com/CCEW/career-ops/issues/819)) ([a0aa264](https://github.com/CCEW/career-ops/commit/a0aa26421b9abc14079f950519bad934134db66c))
* **generate-pdf:** inline local fonts as data: URLs so they actually embed ([#952](https://github.com/CCEW/career-ops/issues/952)) ([08d1e9a](https://github.com/CCEW/career-ops/commit/08d1e9a504cfa8198fb1c84ee824b80de2324df8))
* gitignore data/active-interviews.md (user interview data) ([267dfb7](https://github.com/CCEW/career-ops/commit/267dfb7079877e2beb2a949eb7b404b7bd257332))
* ignore logo cache directory ([#1577](https://github.com/CCEW/career-ops/issues/1577)) ([f51b948](https://github.com/CCEW/career-ops/commit/f51b948fb9a7902d4da017840ea83e9dd1d21f6c))
* images not rendering in PDF output due to about:blank origin ([#1165](https://github.com/CCEW/career-ops/issues/1165)) ([81752df](https://github.com/CCEW/career-ops/commit/81752df3889a7fa6bce76c5f406482203c1cfdab))
* **infra:** exempt web/ from the SYSTEM_PATHS coverage guard (isolation contract) ([8a23564](https://github.com/CCEW/career-ops/commit/8a235649881dc5fa5f4511accf154355da155ade))
* **interview-redflag:** drop GitHub PR references from candidate-facing output templates ([aa35162](https://github.com/CCEW/career-ops/commit/aa35162f47b09f92e892cb0d6aa9c59dffb8673b))
* **latex:** language-agnostic section validation + CJK guard ([#1054](https://github.com/CCEW/career-ops/issues/1054)) ([b147504](https://github.com/CCEW/career-ops/commit/b147504ade6f1f6fb0445dbe09dfcf380ab01260))
* **ledger-bot:** make the first-contribution confirmation copy match what ships ([89e1741](https://github.com/CCEW/career-ops/commit/89e17418bcf8d177f27a768c5282f0ecdb81cd85))
* **ledger-bot:** restore the 'done' confirmation now that the certificate render is live ([9c033d2](https://github.com/CCEW/career-ops/commit/9c033d20f319b412e879539cee4aef864582084a))
* **liveness:** add Ashby API rung so live jobs.ashbyhq.com postings aren't false-expired ([#1372](https://github.com/CCEW/career-ops/issues/1372)) ([b7bc6f3](https://github.com/CCEW/career-ops/commit/b7bc6f38497ff423de3865f6ad729b0f511a8adf))
* **liveness:** treat off-posting redirects as uncertain, not active ([c1cd458](https://github.com/CCEW/career-ops/commit/c1cd4586606f67aa87f263ee21bc165443851bca))
* load profile and custom rules deterministically in all mode paths ([#1736](https://github.com/CCEW/career-ops/issues/1736)) ([#1759](https://github.com/CCEW/career-ops/issues/1759)) ([738a5c7](https://github.com/CCEW/career-ops/commit/738a5c7969ffc51ec4546e0e8b33a9cbe6cf0fe0))
* **merge-tracker:** detect TSV score/status column order by header ([#1517](https://github.com/CCEW/career-ops/issues/1517)) ([423fc1f](https://github.com/CCEW/career-ops/commit/423fc1f45ed9e6a5b6e1ed623e14a67a028ccea7)), closes [#1427](https://github.com/CCEW/career-ops/issues/1427)
* **merge-tracker:** guard tier-3 fuzzy dedup with req/job number ([#1525](https://github.com/CCEW/career-ops/issues/1525)) ([fdb4376](https://github.com/CCEW/career-ops/commit/fdb4376f39051db7102bf48eb0ec8d73cafb7ef9)), closes [#1524](https://github.com/CCEW/career-ops/issues/1524)
* **merge-tracker:** preserve empty interior cells in tracker-row parsing ([#1824](https://github.com/CCEW/career-ops/issues/1824)) ([a477638](https://github.com/CCEW/career-ops/commit/a477638b30a19d95a4a47db5938fb600fb0f75da))
* **merge-tracker:** require company match for number-based dedup ([2bb514f](https://github.com/CCEW/career-ops/commit/2bb514f31b38c7a520545da0c4d3567f7103f608)), closes [#912](https://github.com/CCEW/career-ops/issues/912)
* **merge-tracker:** serialize concurrent tracker merges with a filesystem lock ([#941](https://github.com/CCEW/career-ops/issues/941)) ([0d57994](https://github.com/CCEW/career-ops/commit/0d579944d99276cf85d0d2280cc2697ee7a95140))
* **modes:** bound subagent delegation to prevent research fan-out ([#1268](https://github.com/CCEW/career-ops/issues/1268)) ([1cf34a9](https://github.com/CCEW/career-ops/commit/1cf34a91f6840440de5d641805d118c4c65d29cc)), closes [#1235](https://github.com/CCEW/career-ops/issues/1235)
* **modes:** enforce modes/_custom.md overrides across mode files ([#1621](https://github.com/CCEW/career-ops/issues/1621)) ([1d87f1e](https://github.com/CCEW/career-ops/commit/1d87f1e208d3ca5e38d7afdd76b44d24b976597b)), closes [#1618](https://github.com/CCEW/career-ops/issues/1618)
* **modes:** wire modes/_custom.md into the read path — house rules were write-only ([76b45a8](https://github.com/CCEW/career-ops/commit/76b45a8997135d8bfaf245876a987264d803b7cb))
* normalize report links from data files ([#1134](https://github.com/CCEW/career-ops/issues/1134)) ([6ae011f](https://github.com/CCEW/career-ops/commit/6ae011f22813b63879707f35affc9584fffdb891))
* **onboarding:** auto-copy template seeds in doctor --json ([#782](https://github.com/CCEW/career-ops/issues/782), [#1369](https://github.com/CCEW/career-ops/issues/1369)) ([#1369](https://github.com/CCEW/career-ops/issues/1369)) ([3c06b46](https://github.com/CCEW/career-ops/commit/3c06b461903ce2d8c935862b433a1ff2b65039dc))
* **onboarding:** relay the manifesto note in agent-mediated updates ([0a3abed](https://github.com/CCEW/career-ops/commit/0a3abeddfa66ceb2f3e63f5f951fbbcb85481a4b))
* **paths:** prefer cygpath over wslpath in toBashPath() ([#1503](https://github.com/CCEW/career-ops/issues/1503)) ([b4f5a83](https://github.com/CCEW/career-ops/commit/b4f5a83618de4ef90c26ea2130c0bb6dc44d2a85))
* **pdf:** auto-install Playwright chromium after update ([eb504ad](https://github.com/CCEW/career-ops/commit/eb504adec46ac7b144d1cbc8ca6e2cc6f18173e3))
* **pdf:** clean temporary HTML when browser launch fails ([#1786](https://github.com/CCEW/career-ops/issues/1786)) ([2c17f04](https://github.com/CCEW/career-ops/commit/2c17f04b842910725ae34ff93bdd62c7aeabd7d7))
* **pdf:** drop empty Projects section instead of rendering a bare header ([#1879](https://github.com/CCEW/career-ops/issues/1879)) ([a64d590](https://github.com/CCEW/career-ops/commit/a64d59063d234ed65175491da37f83a47f0a35b4))
* **pdf:** explain the agentic HTML flow in generate-pdf.mjs usage output ([7ae6eb0](https://github.com/CCEW/career-ops/commit/7ae6eb0fba5702638518da7e141cdfbb68491582))
* **pdf:** keep a right gutter so right-aligned CV content isn't clipped ([#1341](https://github.com/CCEW/career-ops/issues/1341)) ([#1351](https://github.com/CCEW/career-ops/issues/1351)) ([37c0703](https://github.com/CCEW/career-ops/commit/37c07033de3cf872a9f40cc2ca33f400a1192db7))
* **pdf:** render markdown bold in CV summary as &lt;strong&gt; (ATS-safe) ([b12cf41](https://github.com/CCEW/career-ops/commit/b12cf41016974d5edce45e346021b3b3861a7fde))
* **pdf:** thread manifest metadata through render options ([#1367](https://github.com/CCEW/career-ops/issues/1367)) ([c7e2439](https://github.com/CCEW/career-ops/commit/c7e2439c1b7d2a031900404439dc2d27d93f1f88))
* **pdf:** use ATS-safe system fonts for clean CV text extraction ([17033e8](https://github.com/CCEW/career-ops/commit/17033e8213a519aa082e790b3cc4702f5bd7266b)), closes [#1074](https://github.com/CCEW/career-ops/issues/1074)
* **pdf:** use CSS [@page](https://github.com/page) setup for margins ([#1563](https://github.com/CCEW/career-ops/issues/1563)) ([d057218](https://github.com/CCEW/career-ops/commit/d057218e0aa1124002b38134e277e8c76e575b38))
* **pipeline:** add batch liveness sweep for unconfirmed entries ([#750](https://github.com/CCEW/career-ops/issues/750)) ([#973](https://github.com/CCEW/career-ops/issues/973)) ([e9eba87](https://github.com/CCEW/career-ops/commit/e9eba87367740080e2330b0c6f1e025231e01d86))
* **plugin:** drop non-schema skills/permissions keys from plugin.json ([5ff910c](https://github.com/CCEW/career-ops/commit/5ff910c0014a9d0f6061b65acd2472d15a72487b))
* **plugins:** harden manifest path containment against symlink traversal ([#1532](https://github.com/CCEW/career-ops/issues/1532)) ([9d0be62](https://github.com/CCEW/career-ops/commit/9d0be62f20c45d3b4892a54f780f28a0baf399f0))
* **portals:** validator accepts provider-plugin ids like the runtime does ([#1756](https://github.com/CCEW/career-ops/issues/1756)) ([eee7ec0](https://github.com/CCEW/career-ops/commit/eee7ec0546e319ca93140608fc125669fbb737b2))
* prevent notion plugin from mangling slash-formatted scores ([#1414](https://github.com/CCEW/career-ops/issues/1414)) ([#1417](https://github.com/CCEW/career-ops/issues/1417)) ([6ea2e5f](https://github.com/CCEW/career-ops/commit/6ea2e5f63a172d00e5e64712bc8fb72d6562b680))
* prevent role-matcher from collapsing different seniorities ([#1622](https://github.com/CCEW/career-ops/issues/1622)) ([dd45bcb](https://github.com/CCEW/career-ops/commit/dd45bcbbdb425caa61183fe02336c51d440598b3)), closes [#1616](https://github.com/CCEW/career-ops/issues/1616)
* **providers:** avature parser tolerates two live tenant markup variants ([#1541](https://github.com/CCEW/career-ops/issues/1541)) ([1f59f2b](https://github.com/CCEW/career-ops/commit/1f59f2b6ade03883372e4acb011e8194e43e7a2a))
* **providers:** harden lever/ashby/workday against SSRF via redirect ([950aad5](https://github.com/CCEW/career-ops/commit/950aad59475a95ddcf842f1556c0de839d5b50a1))
* **providers:** harden workday pagination against 429s, API caps, and dateless tenants ([#1419](https://github.com/CCEW/career-ops/issues/1419)) ([13f80d5](https://github.com/CCEW/career-ops/commit/13f80d5643f360b1702d40d449ca330a07752b0d))
* **providers:** support explicit api: override for ashby/lever with host-pinned guards ([6e010fe](https://github.com/CCEW/career-ops/commit/6e010fe9613ae16fa08b6a291473128c1097af2e))
* **providers:** update Glints API to v2-alc/searchJobsV3, document Jobstreet GraphQL migration ([#1173](https://github.com/CCEW/career-ops/issues/1173)) ([cf863f7](https://github.com/CCEW/career-ops/commit/cf863f721585bba32ee6409d708a59afe37b1631))
* **providers:** workday honors ctx.maxPages so the liveness probe stops cleanly ([#1553](https://github.com/CCEW/career-ops/issues/1553)) ([39216f0](https://github.com/CCEW/career-ops/commit/39216f0661b861d78c5d6700d864a0b9b83e6478))
* **recruitee:** keep offer URLs on tenant custom domains ([#1116](https://github.com/CCEW/career-ops/issues/1116)) ([7c7fd99](https://github.com/CCEW/career-ops/commit/7c7fd994d005557c0f14c4f29376ead33ced4d9f))
* remove story-bank.md from git tracking ([#944](https://github.com/CCEW/career-ops/issues/944)) ([67662b9](https://github.com/CCEW/career-ops/commit/67662b9dad68175a06c631baac523437a93d44f2))
* **reserve-report-num:** support report numbers past 999 ([#1785](https://github.com/CCEW/career-ops/issues/1785)) ([e53b08e](https://github.com/CCEW/career-ops/commit/e53b08e9ba7a48ed50da69bb58d7a463318821ea))
* **role-matcher:** keep base titles distinct from specialized-suffix siblings ([#1922](https://github.com/CCEW/career-ops/issues/1922)) ([723f727](https://github.com/CCEW/career-ops/commit/723f727f739e56fe8ad147c124f01851d1649f4d)), closes [#1881](https://github.com/CCEW/career-ops/issues/1881)
* **scan-ats-full:** reject unrecognized CLI flags with usage help ([#1635](https://github.com/CCEW/career-ops/issues/1635)) ([06fa92b](https://github.com/CCEW/career-ops/commit/06fa92b021d9b790df1eb28df160daf7501c1493))
* **scan-ats-full:** respect data/blacklist.md ([#1914](https://github.com/CCEW/career-ops/issues/1914)) ([6512870](https://github.com/CCEW/career-ops/commit/65128701a062d30c7754405c687eef4a710a49c8)), closes [#1911](https://github.com/CCEW/career-ops/issues/1911)
* **scan:** guard title-filter keyword normalization against malformed config ([#1187](https://github.com/CCEW/career-ops/issues/1187)) ([68c0cdf](https://github.com/CCEW/career-ops/commit/68c0cdf340a6066c21038ae6e8665ffc4d8c22d2))
* **scan:** load .env credentials via optional dotenv import ([#1507](https://github.com/CCEW/career-ops/issues/1507)) ([5066b28](https://github.com/CCEW/career-ops/commit/5066b284400cbc51b246eeff64c42af9f34e5c43))
* **scan:** match short acronym title-filter keywords on word boundaries ([#1102](https://github.com/CCEW/career-ops/issues/1102)) ([424f864](https://github.com/CCEW/career-ops/commit/424f8645d2339b76eaf427629029d34627ac7ccd))
* **scan:** quiet dotenv so --json stdout stays parseable ([#1907](https://github.com/CCEW/career-ops/issues/1907)) ([2e0b29e](https://github.com/CCEW/career-ops/commit/2e0b29ebd1a8a2e67c249c65aa132749c99098f9)), closes [#1906](https://github.com/CCEW/career-ops/issues/1906)
* **scan:** restore browser-like headers on Workday CXS requests ([#1813](https://github.com/CCEW/career-ops/issues/1813)) ([14022de](https://github.com/CCEW/career-ops/commit/14022de87cdfa858c137553e4cd1f8b61a02f755)), closes [#1811](https://github.com/CCEW/career-ops/issues/1811)
* **scan:** sanitize external metadata before writes ([#1098](https://github.com/CCEW/career-ops/issues/1098)) ([61bad36](https://github.com/CCEW/career-ops/commit/61bad36fc4547c7f28b1ed92e963c9f8143c35c5))
* **scan:** tighter company matching and dedup order for cooldown filter ([#1201](https://github.com/CCEW/career-ops/issues/1201)) ([7d76fc7](https://github.com/CCEW/career-ops/commit/7d76fc7061841db9bcf58acf05c38aa489ffbf3e))
* **scan:** trim title-filter keywords before the length check ([#1261](https://github.com/CCEW/career-ops/issues/1261)) ([0842bbf](https://github.com/CCEW/career-ops/commit/0842bbf2beb1a6601bbdf2e06bc9b0a5a77e5cb2))
* **security:** harden batch tmpfile, PDF output path, and tracker cells ([#1315](https://github.com/CCEW/career-ops/issues/1315)) ([ec3023b](https://github.com/CCEW/career-ops/commit/ec3023b6ac9a47932d5e543edd176c72ecdf23f0))
* **security:** harden local-parser against command/arg injection and scan-ats against SSRF ([721f1a8](https://github.com/CCEW/career-ops/commit/721f1a863a83d188242a474df3e54c2b673e5b99))
* **template:** emit mailto:/tel: links for email and phone in CV header ([#1167](https://github.com/CCEW/career-ops/issues/1167)) ([7a4b3b6](https://github.com/CCEW/career-ops/commit/7a4b3b6b3d508c9e2d2064df2a45e942a6a78335))
* **templates:** allowlist the template format to prevent path traversal ([#1776](https://github.com/CCEW/career-ops/issues/1776)) ([54fc973](https://github.com/CCEW/career-ops/commit/54fc9733ba167228460cc1d6b346e61b030ab08b))
* **template:** scope break-inside to atomic units to prevent CV pagination breaks ([7ef8182](https://github.com/CCEW/career-ops/commit/7ef81821684b9959acc0f9e76bef2169ca5d6ec0))
* **templates:** disable fi/fl ligatures for ATS-clean PDF text extraction ([#1175](https://github.com/CCEW/career-ops/issues/1175)) ([#1176](https://github.com/CCEW/career-ops/issues/1176)) ([51ef241](https://github.com/CCEW/career-ops/commit/51ef24101bd2684ddb4103c51f1ac0df6c9f26ee))
* **test:** normalize CRLF at read time for doc assertions ([#1771](https://github.com/CCEW/career-ops/issues/1771)) ([#1772](https://github.com/CCEW/career-ops/issues/1772)) ([b7a1ea1](https://github.com/CCEW/career-ops/commit/b7a1ea12f3c079b17dee61d9f77f47c36b462ed8))
* **tests:** close CodeQL command-injection findings in the test harness ([9cd6dbc](https://github.com/CCEW/career-ops/commit/9cd6dbc0c0dc17361d0babdece2803979f183069))
* **tests:** skip web-reader tests when web/ is absent on core-only installs ([#1675](https://github.com/CCEW/career-ops/issues/1675)) ([32dde78](https://github.com/CCEW/career-ops/commit/32dde7849b117f2c7c37205327af313f31dc7a5c))
* **tracker:** detect and prevent duplicate tracker # numbers ([#1704](https://github.com/CCEW/career-ops/issues/1704)) ([d9cc272](https://github.com/CCEW/career-ops/commit/d9cc272c76f69cbf9708477dfadc813abc8d6e23))
* **tracker:** preserve notes column when rewriting rows without a trailing pipe ([#1004](https://github.com/CCEW/career-ops/issues/1004)) ([0569518](https://github.com/CCEW/career-ops/commit/0569518b22eae190df0eeb6675536aaa89c71840))
* **tracker:** prevent dedup from deleting distinct same-company roles ([#950](https://github.com/CCEW/career-ops/issues/950)) ([98b32a4](https://github.com/CCEW/career-ops/commit/98b32a445abe1bb464dbc15ebb1c450a82772564))
...
* **tracker:** share header-name column mapping across all readers ([#1293](https://github.com/CCEW/career-ops/issues/1293)) ([c54ba3b](https://github.com/CCEW/career-ops/commit/c54ba3b5feff3627aec07434230f8434f7de6f3d))
* unify atomic report number allocation ([#1910](https://github.com/CCEW/career-ops/issues/1910)) ([3b265cb](https://github.com/CCEW/career-ops/commit/3b265cb765ed7f85aded5ef2daa30ffec0bf42f3)), closes [#1733](https://github.com/CCEW/career-ops/issues/1733) [#1801](https://github.com/CCEW/career-ops/issues/1801) [#1835](https://github.com/CCEW/career-ops/issues/1835) [#1895](https://github.com/CCEW/career-ops/issues/1895)
* **update-system:** add .claude/hooks/ to USER_PATHS ([#1676](https://github.com/CCEW/career-ops/issues/1676)) ([e9bacc4](https://github.com/CCEW/career-ops/commit/e9bacc484185f56cec210ea821bf1774e989acea))
* **update-system:** attribute the post-update manifesto link (utm_source=updater) ([a363ec4](https://github.com/CCEW/career-ops/commit/a363ec45ec2fd101d80ca9cf5ba2f882f65cb029))
* **update-system:** keep the updater self-loading to survive old→new re-exec ([#1706](https://github.com/CCEW/career-ops/issues/1706)) ([ce72879](https://github.com/CCEW/career-ops/commit/ce7287960b3d16224f8af17ea2f5a5e5e7590543))
* **update-system:** surface commit failures instead of silently swallowing them ([#1855](https://github.com/CCEW/career-ops/issues/1855)) ([2ad3453](https://github.com/CCEW/career-ops/commit/2ad3453980d49a44ce10470b21cd2434db9701fa)), closes [#1844](https://github.com/CCEW/career-ops/issues/1844)
* **update:** distribute missing runtime paths ([#991](https://github.com/CCEW/career-ops/issues/991)) ([85ae717](https://github.com/CCEW/career-ops/commit/85ae717b8dd331a87ffb58f66181465f4509a17c))
* **update:** make updater timeout budgets configurable ([#1564](https://github.com/CCEW/career-ops/issues/1564)) ([525c9c0](https://github.com/CCEW/career-ops/commit/525c9c0cbc8b6ab5b23a0e612537c75cab83b114))
* **update:** materialize skill entrypoints without symlinks ([#1067](https://github.com/CCEW/career-ops/issues/1067)) ([3ef63c8](https://github.com/CCEW/career-ops/commit/3ef63c8531c60c3cd1a5f8a6088097f914b89907))
* **update:** preserve local CLAUDE.md additions during /career-ops update ([#1446](https://github.com/CCEW/career-ops/issues/1446)) ([e5f5d25](https://github.com/CCEW/career-ops/commit/e5f5d2517ef598350065af1d2475e08bb28c02da))
* **updater:** add .claude/settings.json to USER_PATHS ([#1471](https://github.com/CCEW/career-ops/issues/1471)) ([aa8000d](https://github.com/CCEW/career-ops/commit/aa8000d84c397145196f8f494beefe86777e1090)), closes [#1408](https://github.com/CCEW/career-ops/issues/1408)
* **update:** raise local git timeout default 30s -&gt; 120s for cloud-evicted trees ([a7b5dfd](https://github.com/CCEW/career-ops/commit/a7b5dfd8c8c42c00f73b1bfa1c51338880637bf8))
* **update:** rebuild dashboard binary after Go source changes ([#953](https://github.com/CCEW/career-ops/issues/953)) ([5382d37](https://github.com/CCEW/career-ops/commit/5382d37f65dde222d73ce059f804be9f4853d922))
* **updater:** git-safety on abort + preserve user files on safety-violation rollback ([#915](https://github.com/CCEW/career-ops/issues/915)) ([#1099](https://github.com/CCEW/career-ops/issues/1099)) ([deef636](https://github.com/CCEW/career-ops/commit/deef6365fa01604f7d6abcd14e1817e22c0d2b05))
* **updater:** resolve self-reexec checkout from the import closure ([#1267](https://github.com/CCEW/career-ops/issues/1267)) ([0a830b5](https://github.com/CCEW/career-ops/commit/0a830b5092076b2c7037e4d24ea2b86067b400a9)), closes [#1245](https://github.com/CCEW/career-ops/issues/1245)
* **update:** use target updater manifest during apply ([#983](https://github.com/CCEW/career-ops/issues/983)) ([539e47b](https://github.com/CCEW/career-ops/commit/539e47bdc59462c883964549a01e312d58e996e1))
* **upskill:** correct inverted known-skill suppression in targeted mode ([#1851](https://github.com/CCEW/career-ops/issues/1851)) ([4d95d70](https://github.com/CCEW/career-ops/commit/4d95d70704762dabcc540fe1f0b93cc9a2d78c41))
* **upskill:** keep fetched JD text as a string in the targeted --url-text path ([#1917](https://github.com/CCEW/career-ops/issues/1917)) ([c7e9ff5](https://github.com/CCEW/career-ops/commit/c7e9ff5993026131c67fa69077f0b54c293bb059)), closes [#1894](https://github.com/CCEW/career-ops/issues/1894)
